    ...
    var Calendar = function (params) {
        ...
        p.initCalendarEvents = function () {
            ...
            function handleTouchStart (e) {
                ...
                // e.preventDefault(); e.targetTouches[0]
                isTouched = true;
                touchStartX = touchCurrentY = e.type === 'touchstart' ? e.originalEvent.touches[0].pageX : e.pageX;
                touchStartY = touchCurrentY = e.type === 'touchstart' ? e.originalEvent.touches[0].pageY : e.pageY;
            ...
            function handleTouchMove (e) {
                ...
                touchCurrentX = e.type === 'touchmove' ? e.originalEvent.touches[0].pageX : e.pageX;
                touchCurrentY = e.type === 'touchmove' ? e.originalEvent.touches[0].pageY : e.pageY;
...
+function ($) {
    ...
    $.initSwipePanels = function () {
        ...
        function handleTouchStart(e) {
            ...
            touchesStart.x = e.type === 'touchstart' ? e.originalEvent.touches[0].pageX : e.pageX;
            touchesStart.y = e.type === 'touchstart' ? e.originalEvent.touches[0].pageY : e.pageY;
            if (swipePanelCloseOpposite || swipePanelOnlyClose) {
